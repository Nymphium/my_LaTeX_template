\documentclass[unicode,compress,final,mathserif]{beamer}
...
\setbeamertemplate{headline}{%
    ...
    \begin{beamercolorbox}[dp=5pt,sep=6pt,rightskip=5pt,leftskip=5pt]{headline}%
...
\setbeamertemplate{footline}{%
    \begin{beamercolorbox}[sep=0pt,dp=9pt,rightskip=5pt,leftskip=5pt]{footline}%
