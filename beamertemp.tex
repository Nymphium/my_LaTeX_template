\usepackage{multicol,hanging,ifluatex,xcolor,xhfill,amsmath}%
\usecolortheme{lily}%
...
\newenvironment{toccol}{\iftocmonocol\relax\else\begin{multicols}{\thetoccolnum}\fi}{\iftocmonocol\relax\else\end{multicols}\fi}%
%%%%% [[[
\makeatletter%
\ifluatex\else%
  \newlength\zw%
  ...
  \ifnoframetitle\else%
    \ifx\insertframesubtitle\empty%
      \begin{beamercolorbox}{frametitle}%
        {\large$\blacksquare$\insertframetitle}\par%
        \vskip-.7\zh\xhrulefill{titleblue}{1pt}
      \end{beamercolorbox}%
    \else%
      \begin{beamercolorbox}{framesubtitle}%
        {\large$\bullet$\insertframesubtitle}\par%
        \vskip-.7\zh\xhrulefill{titleblue}{1pt}
      \end{beamercolorbox}
    \fi\fi}%
...
\setbeamertemplate{headline}{%
  \begin{beamercolorbox}{headline}%
    \centering\ifnoheader\else\large\thetitle\fi%
  \end{beamercolorbox}%
  \begin{beamercolorbox}{subheadline}%
    \centering\ifnosubheader\else\large\thetitle\fi%
  \end{beamercolorbox}}%
